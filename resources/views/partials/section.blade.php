    ...
    <div class="container px-4">
        <div class="row gx-4 justify-content-center">
            <div class="col-lg-8">
                ...
                <p class="lead">Polres pematang siantar adalah salah satu bagian dari Polda Sumatera Utara yang
                    bertempat di Kota Pematang Siantar, Provinsi Sumatera Utara. Polres adalah singkatan dari Kepolisi
                    Resort dan Polres Pematang Siantar adalah salah satu unit kepolisian di tingkat kota yang
                    bertanggung jawab atas penegakan hukum di wilayahnya. Polres Pematang Siantar memiliki tanggung
                    jawab untuk menjaga keamanan dan ketertiban di kota tersebut, menginvestigasi kejahatan, dan
                    melaksanakan tugas-tugas kepolisian lainnya sesuai dengan hukum yang berlaku.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="bg-light" id="services" style="padding: 80px 0;">
    <div class="container px-4">
        <div class="row gx-4 justify-content-center">
            <div class="col-lg-8">
                <h2>Keluhan anda...</h2>
                <p class="lead">Selamat datang di layanan keluhan kami. Kami senantiasa berusaha untuk meningkatkan
                    kualitas pelayanan kepada masyarakat. Jika Anda memiliki keluhan atau masukan terkait layanan kami,
                    silakan berikan informasinya di sini. Kami sangat menghargai kontribusi Anda dalam membantu kami
